...
class Z3Verifier(Verifier):
    ...
    def __init__(self, n_vars, equilibrium, inner_radius, outer_radius, margin, z3_vars):
        super().__init__(n_vars, equilibrium, inner_radius, outer_radius, margin, z3_vars)
